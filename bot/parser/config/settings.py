...
PARSER_AUTO_APPROVE_SCHEDULED_DRAIN_ROUNDS: int = max(
    1, _tuning.PARSER_AUTO_APPROVE_SCHEDULED_DRAIN_ROUNDS
)
PARSER_AUTO_APPROVE_PACE_ENABLED: bool = _tuning.PARSER_AUTO_APPROVE_PACE_ENABLED
PARSER_AUTO_APPROVE_PACE_BUFFER_MIN: int = max(
    0, int(_tuning.PARSER_AUTO_APPROVE_PACE_BUFFER_MIN)
)
